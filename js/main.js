...
const jobBaseData = {
    "Beggar": {name: "Beggar", maxXp: 20, income: 10},
    "Farmer": {name: "Farmer", maxXp: 50, income: 15},
    "Fisherman": {name: "Fisherman", maxXp: 100, income: 25},
    "Miner": {name: "Miner", maxXp: 200, income: 60},
    "Blacksmith": {name: "Blacksmith", maxXp: 400, income: 120},
    "Merchant": {name: "Merchant", maxXp: 800, income: 250},

    "Squire": {name: "Squire", maxXp: 50, income: 50},
    "Footman": {name: "Footman", maxXp: 500, income: 175},
    "Veteran footman": {name: "Veteran footman", maxXp: 5000, income: 280},
    "Knight": {name: "Knight", maxXp: 50000, income: 600},
    "Veteran knight": {name: "Veteran knight", maxXp: 500000, income: 3500},
    "Elite knight": {name: "Elite knight", maxXp: 3500000, income: 9500},
...
gameData.requirements = {
    ...
    "Rebirth tab": new AgeRequirement([document.getElementById("rebirthTabButton")], [{requirement: 10}]),
    "Rebirth note 1": new AgeRequirement([document.getElementById("rebirthNote1")], [{requirement: 20}]),
    "Rebirth note 2": new AgeRequirement([document.getElementById("rebirthNote2")], [{requirement: 25}]),
    "Rebirth note 3": new AgeRequirement([document.getElementById("rebirthNote3")], [{requirement: 25}]),
