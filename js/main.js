...
gameData.requirements = {
    ...
    "Rebirth note 1": new AgeRequirement([document.getElementById("rebirthNote1")], [{requirement: 10}]),
    "Rebirth note 2": new AgeRequirement([document.getElementById("rebirthNote2")], [{requirement: 10}]),
    "Rebirth note 3": new AgeRequirement([document.getElementById("rebirthNote3")], [{requirement: 10}]),
